<template>
  <div class="mb-4 font-medium text-sm text-green-600">
    <div class="flex flex-col items-center justify-center py-4 mx-auto">
      <div
      ...
      >
        ...
        <div class="mt-10">
          ...
          <div class="flex w-full">
            ...
            >
              <span class="mr-2 uppercase" @click="signup">Sign Up</span>
              <span>
                <svg
                  class="h-6 w-6"
                  fill="none"
...
export default {
  ...
  methods: {
    async login_() {
      try {
        await axios.post("http://127.0.0.1:8000/api/account/signup", {
          email: this.email,
